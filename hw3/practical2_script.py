...
ax15.set_yticks([0,25,50,75,100])
ax2.set_xticklabels([])
ax2.set_yticks([0,20,40])
ax3.set_xticks(xtick_locs)
ax3.set_xticklabels(xtick_labels,rotation=75)
ax3.set_yticks([3.0,4.0,5.0])

ax1.set_xlim(mttime[0],mttime[-1])
ax2.set_xlim(mttime[0],mttime[-1])
ax3.set_xlim(mttime[0],mttime[-1])

fig.suptitle('Temp/RH, Rain, and Gauge Height Data')
